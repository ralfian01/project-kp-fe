    ...
    <Container header={<ContainerTitle>Edit pemohon</ContainerTitle>}>
      <form ref={formRef} onSubmit={handleSubmit}>
        <Input
          ...
          defaultValue={applicantData?.recommender_name ?? ""}
          required={true}
          validationRules={{
            required: (val: any) => (!val ? "Wajib diisi" : ""),
          }}
          warningText={
            findRevisedReasonByColumn(
              applicantData.revision,
              "recommender_name",
            )?.reason ?? ""
          }
        />
        ...
        <Input
          ...
          required={true}
          disabled={["DRAFT", "REVISE"].indexOf(applicantData.status) < 0}
          defaultValue={applicantData.identity?.full_name ?? ""}
          validationRules={{
            required: (val: any) => (!val ? "Wajib diisi" : ""),
          }}
          warningText={
            findRevisedReasonByColumn(applicantData.revision, "full_name")
              ?.reason ?? ""
          }
        />
        ...
        <div className="mt-4 grid grid-cols-1 items-end gap-3 gap-y-5 md:grid-cols-2">
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "phone_number")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "pass_photo")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "id_card_photo")
                ?.reason ?? ""
            }
          />
        ...
        <div className="mt-4 grid grid-cols-1 items-end gap-3 gap-y-5 md:grid-cols-2">
          ...
          <Select
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "id_card_city")
                ?.reason ?? ""
            }
          />
        ...
        <Textarea
          ...
          warningText={
            findRevisedReasonByColumn(applicantData.revision, "id_card_address")
              ?.reason ?? ""
          }
        />
        ...
        <div className="mt-4 grid grid-cols-1 items-end gap-3 gap-y-5 md:grid-cols-2">
          <Select
            ...
            disabled={
              ["DRAFT", "REVISE"].indexOf(applicantData.status) < 0
                ? true
                : !isDomicileFillable
            }
            onInput={(e: any) =>
          ...
          <Select
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "domicile_city")
                ?.reason ?? ""
            }
          />
        ...
        <div className="mt-4 grid grid-cols-3 items-end gap-3 gap-y-5">
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "coor_lat")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "coor_long")
                ?.reason ?? ""
            }
          />
        ...
        <div className="mt-4 grid grid-cols-1 items-end gap-3 gap-y-5 md:grid-cols-2">
          <Select
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "bank_name")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "bank_number")
                ?.reason ?? ""
            }
          />
        ...
        <div className="mt-4 grid grid-cols-1 items-end gap-3 gap-y-5 md:grid-cols-2">
          ...
          <Select
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "major_level")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "university")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "major_name")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "gpa")
                ?.reason ?? ""
            }
          />
        ...
        <div className="mt-4 grid grid-cols-1 items-end gap-3 gap-y-5 md:grid-cols-2">
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "house_photo")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "scholarship")
                ?.reason ?? ""
            }
          />
          ...
          <Input
            ...
            warningText={
              findRevisedReasonByColumn(applicantData.revision, "pddikti")
                ?.reason ?? ""
            }
          />
